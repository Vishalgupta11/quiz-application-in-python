...
class Quiz:
	...
	def display_title(self):
		...
		title = Label(gui, text="Quiz Application By Vishal And Sushant",
...
gui.title("Quiz Application By Vishal And Sushant")

# get the data from the json file
with open('C:\\Users\Vishal gupta\Desktop\python project\project.json') as f:
	data = json.load(f)  
